...
class Cliente extends ActiveRecord
{
    ...
    protected static $id = 'cliente_id';
    protected static $tabla = 'clientes';
    protected static $columnasDB = [
        'cliente_id ', 'nombre', 'siglas_empresa', 'telefono', 'email', 'sitio_web', 'contacto_principal', 'rfc', 'razon_social',
        'regimen_fiscal', 'giro_comercial', 'calle', 'num_ext', 'num_int', 'colonia', 'codigo_postal', 'municipio', 'ciudad',
        'estado', 'pais', 'estatus', 'fecha_creacion', 'fecha_modificacion', 'user_creacion', 'user_modificacion', 'ip_user', 'tarifa_id'
    ];
    protected static $order = 'cliente_id DESC';
