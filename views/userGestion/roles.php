<section class="contenedor--md center-hv m-t3">
    <div class="flex-titulo">
        ...
        <a class="btn btn-crear" id="crear-rol"><i class="fa-solid fa-user-plus"></i></a>
    </div>
...
<section class="contenedor-altas">
    ...
    <div class="contenedor--sm center-hv" id="contenedor">
        ...
        <form id="formAltas" class="m-rl3 m-t3">
            ...
            <div class="hidden">
                <input type="text" id="rol_id">
            </div>

            <div class="cont-form2">

                <div class="form-group">
                    <input type="text" id="nombre_rol" placeholder="" maxlength="60">
                    <label for="nombre_rol" class="labelImportant">Nombre Rol:</label>
                </div>

                <div class="form-group">
                    <input type="text" id="descripcion" placeholder="" maxlength="255">
                    <label for="descripcion" class="labelImportant">Descripción:</label>
                </div>
