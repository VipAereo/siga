<section class="contenedor--sm center-hv m-t3">
    <div class="flex-titulo">
        ...
        <a class="btn btn-crear" id="crear-tasa">
...
<section class="contenedor-altas">
    <div class="contenedor--sm center-hv" id="contenedor">
        <div class="flex-titulo">
            <h3>Tasa de Aterrizaje</h3>
        </div>

        <form id="formAltas" class="m-rl3 m-t3">

            <div class="hidden">
                <input type="text" id="tasa_aterrizaje_id">
            </div>
            ...
            <div class="cont-form1">
                <div class="form-group">
                    ...
                    <div class="containerSearch aeropSearch">
                        <input placeholder="Buscar..." class="inAeropSrch" type="search">
            ...
            <div class="cont-form2">
                ...
                <div class="form-group">
                    <select name="aeronave_id" id="aeronave_id">
                        <option value=""></option>
                    </select>
                    <label for="aeronave_id" class="labelImportant">Aeronave:</label>

                    <div class="containerSearch naveSearch">
                        <input placeholder="Buscar..." class="inNaveSrch" type="search">
                        <i class="fa-solid fa-magnifying-glass"></i>
                    </div>
                </div>

                <div class="form-group">
                    <input type="text" id="tarifa_aterrizaje" placeholder="" maxlength="15" class="txt-right">
                    <label for="tarifa_aterrizaje" class="labelImportant ">Tarifa Aterrizaje:</label>
                </div>
...
<script src="/build/js/tasaAterrizaje.js"></script>