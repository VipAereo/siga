    ...
    <div class="contenedor--lg center-hv " id="contenedor">
        ...
        <form id="formAltas" class="m-rl3 m-t3">
            ...
            <div class="cont-form3">
                ...
                <input type="hidden" name="csrf_token" id="csrf_token" value="<?php echo htmlspecialchars(generateCsrfToken()); ?>">
        ...
        <div class="cont-btn txt-center m-t3">
            ...
            <button class="btn btn-guardar2 m-b2" id="btnServicio">Servicio</button>
        </div>
    </div>
...
<script src="/build/js/costeo.js"></script>